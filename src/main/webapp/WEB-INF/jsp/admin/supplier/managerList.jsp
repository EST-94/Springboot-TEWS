	...
	<script type="text/javascript">
		 ...
		 */
		 function showUserDetail(cdsid) {
			...
			obj5.setAttribute("name", "ManagerPageNo");
					...
					<table class="board_01" summary="User Quick Menu">
						...
						<thead>
							<tr>
								...
								<th scope="col"><a href="javascript:sortBy('activationDate')">
										<spring:message code="label.activationDate"
											text="Activation Date" />
									</a></th>
								<th scope="col"><a href="javascript:sortBy('expirationDate')">
										<spring:message code="label.expirationDate"
